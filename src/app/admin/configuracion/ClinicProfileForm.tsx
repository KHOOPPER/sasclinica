        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-2">
            ...
            <input
              ...
              required
              className="w-full h-14 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl px-6 text-sm font-bold text-text-main placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all shadow-sm"
            />
          </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-2">
            ...
            <Input id="phone" name="phone" defaultValue={clinic.phone} placeholder="2200-0000" className="h-14 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-none rounded-2xl px-6 text-sm font-bold text-text-main focus:ring-4 focus:ring-blue-600/5 transition-all shadow-sm" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="address" name="address" defaultValue={clinic.address} placeholder="Calle Principal, Edificio Médico, Nivel 2..." className="h-14 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-none rounded-2xl px-6 text-sm font-bold text-text-main focus:ring-4 focus:ring-blue-600/5 transition-all shadow-sm" />
          </div>
        </div>
      </div>
            ...
            <div className="text-right">
              ...
              <h4 className="text-lg font-black text-emerald-500 uppercase tracking-tighter">
                {clinic.tenants?.plan_expires_at 
                  ? new Date(clinic.tenants.plan_expires_at).toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })
