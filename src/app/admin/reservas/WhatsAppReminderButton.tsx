...
export default function WhatsAppReminderButton({ appointment }: WhatsAppReminderButtonProps) {
  ...
  return (
    <Button 
      ...
      className={`rounded-xl px-4 py-2.5 transition-all flex items-center gap-1.5 font-bold text-xs active:scale-95 ${
        isNotified 
          ? 'bg-blue-50 text-[#003366] border-[#003366]/20' 
          : 'text-[#003366] border-[#003366]/20 hover:bg-blue-50 hover:border-[#003366]/40 shadow-sm'
      }`}
    >
      {isPending ? (
