...
export default function MarkAsAttendedButton({ appointmentId }: MarkAsAttendedButtonProps) {
  ...
  return (
    <Button 
      ...
      onClick={handleMark}
      disabled={isPending}
      className="text-[#003366] border-[#003366]/20 hover:bg-blue-50 font-bold text-xs px-4 py-2.5 rounded-xl transition-all flex items-center gap-1.5 shadow-sm active:scale-95"
    >
